...
_DEFAULT_BLOCKS: dict[str, str] = {
    ...
    "llm_training_guidance": (
        ...
        "GPU MEMORY GUIDELINES (single-GPU, budget-constrained environment):\n"
        "- Do NOT assume a specific GPU model or exact VRAM capacity.\n"
        "- Prefer parameter-efficient tuning over full fine-tuning whenever possible.\n"
        "- Start with smaller models and compact batch sizes, then scale up only if the configured budget allows it.\n"
        "- Treat QLoRA/LoRA as the default path for larger models in constrained environments.\n\n"
