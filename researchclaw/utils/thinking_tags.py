...
# Format: `★ Insight ─────...─────`\n...\n`─────...─────`
# Also handles: `* Insight ---...---` (ASCII fallback)
# ---------------------------------------------------------------------------
...
# but may leak through in some code paths
# ---------------------------------------------------------------------------
...
def strip_thinking_tags(text: str) -> str:
    ...
    # Phase 6: Process narration (only if it looks like meta-commentary)
    result = _NARRATION_RE.sub("", result)

    # Phase 7: Clean up artifacts
    # Remove lines that are just horizontal rules from insight blocks
