...
_DEFAULT_BLOCKS: dict[str, str] = {
    ...
    "writing_structure": (
        ...
        "INTRODUCTION (4 paragraphs, 800-1000 words; follow the effective citation policy):\n"
        ...
        "Use only directly relevant references allowed by the effective citation policy.\n\n"
        "METHOD:\n"
    ...
    "academic_style_guide": (
        ...
        "  - Para 1: Motivation; Para 2: Gap (cite eligible prior work); Para 3: Your approach;\n"
        "    Para 4: Contributions (bullet list of 3-4 specific contributions)\n"
        "  - Follow the effective citation policy throughout Introduction\n\n"
        ...
        "  - Use only eligible references under the effective citation policy\n\n"
