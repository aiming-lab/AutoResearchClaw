...
## 2. 当前精确状态(E4/E5 已复审并提交)

- HEAD:本 E4/E5 同窗口 commit "literature: close citation planning and
  final-paper evidence"。其父 commit 为 42b3dc1 E3。
...
- 下一步:审查 E4/E5 同窗口 WIP。E4 新增 strict deterministic
...
- d4db0ab CITATION_EVIDENCE_PIPELINE_SPEC(v1 abstract-only + v2 HITL 全文,
  ...
  e9a7fbd E2;42b3dc1 E3;E4/E5 同窗口 commit(见 §2)。
...
- Stage 18 检测器动词闭集已知 FN("increase ... to 30 references"),
  词表 v2 候选;C3 零 unresolved 是 release 兜底。
